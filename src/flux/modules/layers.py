...
from flux.modules.cache_functions import force_init, cache_cutfresh, cache_cutfresh_img_and_txt, update_cache, smooth_update_cache
        ...
        if cache_dic is None:
            ...
            if (current['type'] == 'full') or (current['type'] == 'Delta-Cache'):    
                ...
                if current['layer'] == 18 and cache_dic['mode'] == 'Taylor-Cluster':
                    ...
                    # print("img_mlp_1", cache_dic['cluster_info'][current['stream']]['img_mlp']['cluster_indices'].shape)
                    # print("txt_mlp_1", cache_dic['cluster_info'][current['stream']]['txt_mlp']['cluster_indices'].shape)
